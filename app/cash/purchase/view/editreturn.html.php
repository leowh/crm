...
<form method='post' id='ajaxForm' class='form-inline' action='<?php echo $this->createLink('purchase', 'editReturn', "returnID={$return->id}")?>'>
    ...
    <tr>
      ...
      <td class='w-p40'>
        <div class='input-group'>
          ...
          <?php $checked = $purchase->return == 'done' ? 'checked' : '';?>
          <div class='input-group-addon'>
            <label class='checkbox'><input type='checkbox' id='finish' name='finish' value='1' <?php echo $checked;?>> <?php echo $lang->purchase->completeReturn;?></label>
          </div>
        </div>
      </td><td></td>
    </tr>
